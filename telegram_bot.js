...
let stats = {
    ...
    maxLevelReached: 1,
    levelHistoryTracker: {},
    knownUsers: [] // नए यूज़र्स को ट्रैक करने के लिए
};
...
// 1️⃣ /start - Smart Welcome
bot.onText(/\/start/, (msg) => {
    const chatId = msg.chat.id;
    const userId = msg.from.id;
    const userName = msg.from.first_name || "VIP Member"; 
    ...
    if (!stats.knownUsers.includes(userId)) {
        ...
        const normalWelcomeMsg = `🌟 <b>TRADE'S STAR V20 (SAFE AI)</b> 🌟\n\nवापसी पर स्वागत है, <b>${userName}</b>!\n\n👉 /stats - लाइव एक्यूरेसी\n👉 /chart - इन्वेस्टमेंट चार्ट\n👉 /rules - ट्रेडिंग नियम\n👉 /ai - AI से सवाल पूछें`;
        bot.sendMessage(chatId, normalWelcomeMsg, { parse_mode: 'HTML' }).catch(()=>{});
    }
});

// 2️⃣ /chart - Investment Chart
