...
const STICKER_WIN = 'CAACAgUAAxkBAAERUPFqHtTN4VV8pNCQ4ITbQ7V-jFquxAACDSEAAsZ0-FTYzidqwhQYsTsE'; 
const STICKER_LOSS = 'CAACAgUAAxkBAAERUPNqHtTZSAABY3Wir5r_KdykUFHqP8MAAg4hAALGdPhUD-JoQKZNgZM7BA';
const STICKER_JACKPOT = 'CAACAgUAAxkBAAERUPVqHtTiunYt2hFKdYOZ5Y4WS3D4YwACDyEAAsZ0-FRAMiKek9wX2TsE';
...
// Format Prediction Type for Fancy Layout
...
async function handleNewOutcome() {
    ...
    if (currentPrediction && currentPrediction.issue === latestId) {
        ...
        // Populate rolling results list for Q3 timelist analysis (IST string)
