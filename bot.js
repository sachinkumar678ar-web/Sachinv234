...
function generatePrediction(nextId) {
    ...
    if (isExtremeZigZag) {
        skipReason = "Extreme Zig-Zag (लगातार मार्केट बदल रहा है)";
        finalSelection = "WAIT";
    } else {
        // 2️⃣ Weighted Score System (बेहतर प्रेडिक्शन के लिए)
        let bigScore = 0, smallScore = 0;
        recentHistory.forEach((item, index) => {
            let weight = 15 - index; // नए रिज़ल्ट को ज़्यादा पावर
...
// ==========================================
// 📢 GROUP NEW MEMBER WELCOME (Discussion Group)
// ==========================================
bot.on('new_chat_members', (msg) => {
    ...
    newMembers.forEach(member => {
        ...
        const welcomeMsg = `🎉 <b>WELCOME TO TRADE'S STAR VIP, ${name}!</b> 🎉\n\n` +
                           `Wingo 1M के सबसे बेहतरीन और सुरक्षित प्रेडिक्शन ग्रुप में आपका स्वागत है।\n\n` +
